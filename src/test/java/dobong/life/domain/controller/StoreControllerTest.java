...
class StoreControllerTest extends BaseControllerTest {
    ...
    void 홈화면_도메인_리스트정보를_반환한다() throws Exception {
        ...
        StoresResDto Dto = TestStoreControllerResponse.makeTestGetStoresResDto(1L, 1L, "행복", 1L,
        ...
        resultActions.andExpect(status().isOk())
                .andExpect(StoreResponseDto.expectedGetStoresResDto());
    }
    ...
    void 검색어에_따른_도메인_정보를_반환한다() throws Exception {
        ...
        //then
        resultActions.andExpect(status().isOk())
                .andExpect(StoreResponseDto.expectedGetStoresResDtoByQuery());
    }
    ...
    void 필터에_따른_도메인_정보를_반환한다() throws Exception {
        ...
        StoresFilterResDto Dto = TestStoreControllerResponse.makeTestGetStoresFilterResDto(1L, categoryNames, subTagNames, storeIds, storeNames, storeLocations, imgUrls, storeLikes);
        ...
        //then
        resultActions.andExpect(status().isOk())
                .andExpect(StoreResponseDto.expectedGetStoresFilterResDto());
    }
    ...
    void 특정_도메인의_상세정보를_반환한다() throws Exception {
        ...
        StoreItemResDto Dto = TestStoreControllerResponse.makeTestGetStoreItemResDto(1L, 1L, "가게1", "위치1",
                "이미지1", false, "서브카테고리명1",
        ...
        //then
        resultActions.andExpect(status().isOk())
                .andExpect(StoreResponseDto.expectedGetStoreItemResDto());
    }
